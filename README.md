...
It investigates:
Whether larger populations are associated with stronger NPFL clubs
Whether geographic location is associated with differences in club performance
Whether the league is becoming more or less competitive
Which clubs demonstrate sustained performance over time
How strong home advantage is within the NPFL
Which players and positions contribute most to scoring
How stadium environments differ in match activity and goal patterns
Whether football performance can be meaningfully modelled using match-level features
What the findings imply for the development of the NPFL ecosystem
---
Dataset Scope
...
See the `sql/` directory for the SQL implementation and warehouse documentation.
---
Python Analysis
...
See `python/` for the analytical notebooks and methodology.
---
